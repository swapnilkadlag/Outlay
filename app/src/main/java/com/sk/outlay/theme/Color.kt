...
fun outlayColor(outlayColor: OutlayColor, isDarkTheme: Boolean = isSystemInDarkTheme()): Color {
    return when (outlayColor) {
        ...
        OutlayColor.LightBlue -> if (isDarkTheme) Color(0xFF4FC3F7) else Color(0xFF03A9F4)
        ...
        OutlayColor.LightGreen -> if (isDarkTheme) Color(0xFFAED581) else Color(0xFF8BC34A)
        ...
        OutlayColor.Amber -> if (isDarkTheme) Color(0xFFFFD54F) else Color(0xFFFFC107)
